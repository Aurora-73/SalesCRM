...
│   └── maintain.md           # 维持关系流程
├── signals/                  # 信号解读子文件
│   ├── basic_signals.md      # 基础信号（意向/冷落/窗口）
│   └── sales_signals.md      # 销售信号（需求确认/决策链/竞品）
├── metrics/                  # 指标体系子文件
│   └── metrics_system.md     # 16维指标详解 + 销售特有指标
└── formulas/                 # 公式子文件
    ├── war_formulas.md       # 战态公式（IVI/SPE/EWS等）
    ├── sales_formulas.md     # 销售公式（BQ/BSP/BWS等）
